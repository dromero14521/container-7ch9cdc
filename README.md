...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-7ch9cdc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-7ch9cdc.containers.anotherwebservice.com/
...
```
git clone git@github.com:dromero14521/container-7ch9cdc.git
cd container-7ch9cdc
```
...
```
docker attach container-7ch9cdc
```
